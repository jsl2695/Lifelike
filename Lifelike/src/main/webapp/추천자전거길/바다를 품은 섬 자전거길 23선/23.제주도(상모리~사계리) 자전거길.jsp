                            ...
                            <div class="sub0203 sub020301">
                                <div class="sub0203_box">
                                    <div class="sub0302_txt">
                                        <strong>한라산 백록담의 뚜껑을 찾아서</strong>
                                        <p>제주환상자전거길 상모리~사계리 구간은 해안도로를 따라 아름다운 제주도의 바다경관을 감상할 수 있다.
                                           더불어 이 구간은 올레길10코스(휠체어구간)으로 장애인도 이용할 수 있고, 초보 라이더에게도 적합한 곳이다.
                                           또한 제주도의 전설에서 한라산 백록담의 뚜껑인 산방산의 웅장한 장관을 보며 라이딩을 할 수 있어 
                                           산과 바다를 한 번에 즐길 수 있는 명소이다.</p>
                                    </div>
                                    <div class="sub0302_img">
                                        <img src="./바다섬img/6103. 제주도(상모리~사계리) 자전거길.JPG" alt="제주도(상모리) 사진">
                                    </div>
                                </div>

                                <h4 class="tith4 mt80">여행코스</h4>
                                <div class="travel_map">
                                    <img src="./바다섬img/33. 재주도 상모리,사계리 자전거길.png" alt="제주도(상모리) 여행코스 지도">
                                </div>
                                
                                <ul class="travel_ul mt40 arrow">
									<li class="travel_ul100">
										<strong>경로</strong>
										<p>상모리 87-19 <span>→</span> 사계리 1247-13</p>
									</li>
									<li class="travel_ul50">
										<strong>소요시간</strong>
										<p>15분 소요 (시속 15km 기준)</p>
									</li>
									<li class="travel_ul50">
										<strong>주행거리</strong>
										<p>3.3km</p>
                                ...
                                <ul class="list4 arrow">
									<li>제주국제공항(급행버스 152번) <span>→</span> 화순환승정류장(지선 752-2번)</li>
									<li>서귀포환승정류장(급행버스 181번) <span>→</span> 창천초등학교(지선 752-2번) ☎ 064-710-7777</li>
								</ul>

                                <h4 class="tith4 mt80">문의전화</h4>
                                <h5 class="tith5">자전거길</h5>
                                <ul class="list4 arrow">
									<li>서귀포시청 건설과 : ☎ 064-760-3097, 3089</li>
								</ul>
