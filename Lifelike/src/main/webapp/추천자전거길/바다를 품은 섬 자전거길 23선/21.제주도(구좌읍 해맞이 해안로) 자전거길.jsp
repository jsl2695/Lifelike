                            ...
                            <div class="sub0203 sub020301">
                                <div class="sub0203_box">
                                    <div class="sub0302_txt">
                                        <strong>바람 맞아도 좋으리... 달리멍, 쉬멍, 놀으멍</strong>
                                        <p>구좌 해맞이해안로 구간으로 대부분의 길이 해안도로를 따라 길이 완만하여 쉽고 즐겁게 바닷바람을 맞으며 주행을 할 수 있는 해안자전거길이다.
                                           구좌읍 하도리에서 시작되는 이 길은 철새도래지, 토끼섬, 세화해수욕장, 월정리해변으로 이어진다. 바다와 어깨를 맞대고 이어지는 
                                           이 해안도로에서는 제주도의 독특한 자연, 민속 생태 등을 다채롭게 만날 수 있는 길이다.
                                           ...
                                           우리나라 유일의 문주란 자생지인 토끼섬, 수심이 얕고 파도가 약해 가족단위 관광객들에게 
                                           인기가 많은 세화 해수욕장으로 이어지고, 젊은 층들의 관광명소로 알려진 월정리 해변은 아기자기한 많은 카페들과 포토스팟으로 
                                           인기를 끌고 있다. 해맞이해안로가 끝날 즈음 되면 김녕 수국길에서 6월이면 만개한 수국을 만날 수 있다.</p>
                                    </div>
                                    <div class="sub0302_img">
                                        <img src="./바다섬img/6100. 제주도(구좌읍 해맞이 해안로) 자전거길.JPG" alt="제주도(구좌읍) 사진">
                                    </div>
                                </div>

                                <h4 class="tith4 mt80">여행코스</h4>
                                <div class="travel_map">
                                    <img src="./바다섬img/31. 제주도 구좌읍 해맞이해안로 자전거길.png" alt="제주도(구좌읍) 여행코스 지도">
                                </div>
                                
                                <ul class="travel_ul mt40 arrow">
									<li class="travel_ul100">
										<strong>경로</strong>
										<p>구좌해안로 <span>→</span> 하도리 철새도래지 <span>→</span> 토끼섬 <span>→</span> 세화해수욕장 <span>→</span> 월정리해변 <span>→</span> 수국길</p>
									</li>
									<li class="travel_ul50">
										<strong>소요시간</strong>
										<p>2시간 소요 (시속 15km 기준) </p>
									</li>
									<li class="travel_ul50">
										<strong>주행거리</strong>
										<p>28km</p>
                                ...
                                <ul class="list4 arrow">
									<li>제주시외버스터미널(711-2번) ☎ 064-710-7777</li>
								</ul>

                                <h4 class="tith4 mt80">문의전화</h4>
                                <h5 class="tith5">자전거길</h5>
                                <ul class="list4 arrow">
									<li>제주시청 도시재생과 : ☎ 064-728-3551~3</li>
								</ul>
                                <h5 class="tith5 mt20">관광</h5>
                                <ul class="list4 arrow">
									<li>제주시청 관광진흥과 : ☎ 064-728-3918~20</li>
									<li>제주관광정보센터 : ☎ 064-740-6000</li>
