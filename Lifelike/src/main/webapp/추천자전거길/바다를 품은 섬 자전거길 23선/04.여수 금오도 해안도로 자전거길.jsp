                            ...
                            <div class="sub0203 sub020301">
                                <div class="sub0203_box">
                                    <div class="sub0302_txt">
                                        <strong>에메랄드 빛 바다가 펼쳐지는 환상의 해안 자전거길</strong>
                                        <p>금오도 해안도로는 자전거동호인들 사이에서 사랑받는 섬투어 코스로 아름다운 바다와 기암괴석들을 
                                           바라보며 라이딩을 즐길 수 있다. 해안도로를 따라가면 만나는 금오도 오토캠핑장과 동고지마을에서는 
                                           섬의 특성을 살린 체험과 숙박이 가능하여 멋진 풍경과 함께 즐거운 시간을 보낼 수 있다.
                                           자전거투어 외에도 금오도 비렁길은 여수 10경 중 하나로 바다풍광을 배경으로 떠 있는 섬 해안가의 
                                           깎아지르는 듯한 절벽을 따라 조성되어 이곳을 찾는 이들의 감탄을 자아낸다.</p>
                                    </div>
                                    <div class="sub0302_img">
                                        <img src="./바다섬img/1400. 여수 금오도 해안도로 자전거길.JPG" alt="여수 금오도 사진">
                                    </div>
                                </div>

                                <h4 class="tith4 mt80">여행코스</h4>
                                <div class="travel_map">
                                    <img src="./바다섬img/14. 여수금오도해안도로자전거길.png" alt="여수 금오도 여행코스 지도">
                                </div>
                                
                                <ul class="travel_ul mt40 arrow">
									<li class="travel_ul100">
										<strong>경로</strong>
										<p><em>(1코스 여수연안여객선터미널 or 신기항 <span>→</span> 여천항)</em><br> 여천항 <span>→</span> 금오도캠핑장 <span>→</span> 남면사무소 <span>→</span> 안도대교 <span>→</span> 안도해수욕장 <span>→</span> 동고지마을<br>
											<em>(2코스 백야항 <span>→</span> 함구미항)</em><br> 함구미항 <span>→</span> 여천항 <span>→</span> 금오도캠핑장 <span>→</span> 남면사무소 <span>→</span> 안도대교 <span>→</span> 안도해수욕장 <span>→</span> 동고지마을
										</p>
									</li>
									<li class="travel_ul50">
										<strong>소요시간</strong>
										<p>약 1시간 40분 소요 (시속 15km 기준)</p>
									</li>
									<li class="travel_ul50">
										<strong>주행거리</strong>
										<p>(1코스) 16.0km, (2코스) 20.4km </p>
									</li>
									<li class="travel_ul100">
										<strong>도로상태</strong>
										<p>포장, 비포장 혼재</p>
                                ...
                                <ul class="list4 arrow">
									<li>여수연안여객선터미널 <span>→</span> 금오도(여천항, 우학항) : ☎ 061-666-8092</li>
									<li>신기항(돌산읍) <span>→</span> 금오도(여천항) : ☎ 061-666-8092</li>
									<li>백야항(화정면) <span>→</span> 금오도(함구미항) : ☎ 061-665-0011</li>
								</ul>
                                <h4 class="tith4 mt80">문의전화</h4>
                                <h5 class="tith5">자전거길</h5>
                                <ul class="list4 arrow">
									<li>여수시청 도로과 : ☎ 061-659-4569</li>
								</ul>
                                <h5 class="tith5 mt20">관광</h5>
                                <ul class="list4 arrow">
									<li>여수시청 관광과 : ☎ 061-659-3877</li>
