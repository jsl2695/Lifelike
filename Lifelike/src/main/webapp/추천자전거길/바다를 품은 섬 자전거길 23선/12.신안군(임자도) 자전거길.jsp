                            ...
                            <div class="sub0203 sub020301">
                                <div class="sub0203_box">
                                    <div class="sub0302_txt">
                                        <strong>눈부신 대광해변 백사장과 푸른 대파의 대향연</strong>
                                        <p>해안 임도와 은빛모래 해변의 하모니
                                           매년 4월이면 튤립축제를 통해 이제는 너무나도 유명한 임자도의 끝이 보이지 않는 
                                           백사장은 사질이 단단해 자전거로 달리기 안성맞춤이며, 어마어마한 길이와 장쾌한 풍경은 달리는 동안 탄성을 자아내게 한다.
                                           끝없이 펼쳐진 푸른 대파밭, 국내최대의 길이와 폭을 자랑하는 광활한 대광해변 라이딩, 
                                           해안 임도에서 바라본 아름다운 바다와 은빛 모래해변의 감동을 느낄 수 있다.</p>
                                    </div>
                                    <div class="sub0302_img">
                                        <img src="./바다섬img/2102. 신안군(임자도) 자전거길.JPG" alt="신안군(임자도) 사진">
                                    </div>
                                </div>

                                <h4 class="tith4 mt80">여행코스</h4>
                                <div class="travel_map">
                                    <img src="./바다섬img/22. 신안군 임자도 자전거길.png" alt="신안군(임자도) 여행코스 지도">
                                </div>
                                
                                <ul class="travel_ul mt40 arrow">
									<li class="travel_ul100">
										<strong>경로</strong>
										<p>진리선착장 <span>→</span> 서울염전 <span>→</span> 전장포항 <span>→</span> 대광해변 <span>→</span> 어머리해변·용난굴</p>
									</li>
									<li class="travel_ul50">
										<strong>소요시간</strong>
										<p>3시간 10분 소요 (시속 15km 기준)</p>
									</li>
									<li class="travel_ul50">
										<strong>주행거리</strong>
										<p>48km</p>
                                ...
                                <ul class="list4 arrow">
									<li>점암항 <span>→</span> 진리항 ☎ 061-275-7303</li>
								</ul>
