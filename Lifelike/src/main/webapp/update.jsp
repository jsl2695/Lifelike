					...
					<nav id="Update">	
						<ul class="actions vertical">
							<li><h5>회원정보수정</h5></li>
								<form action="#">
									<li>접속한 ID :</li>
									<li><input type="text" placeholder="ID를 입력하세요" style="width: 500px; margin: 0 auto;"></li>
									<li><input type="password" placeholder="PW를 입력하세요" style="width: 500px; margin: 0 auto;"></li>
									<li><input type="email" placeholder="E-mail을 입력하세요" style="width: 500px; margin: 0 auto;"></li>
